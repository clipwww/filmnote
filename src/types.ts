...
export interface Certificate {
  /**
   * 確定性的代理主鍵：`年度:字號:正規化片名`。不用 `permitNo`：它只在 113 年唯一——
   * 113 年的字號帶系列前綴，110–112 年沒有，四個系列各自從 001 編號因而全部撞號
   * （110 年 103 組、111 年 105 組、112 年 120 組重複），而前綴無法從國別可靠推回。
   * 此複合鍵在 3,116 筆上實測唯一且為確定性 ⇒ 重跑匯入不會產生重複列。
   */
  id: string
